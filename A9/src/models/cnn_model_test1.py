...
class CNN_Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.convblock1 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, dilation=2, bias=False, padding=2),  # RF = 9
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
        )
        ...
        self.convblock2 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, dilation=2, bias=False, padding=2),
            # RF = 26
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
        ...
        self.convblock3 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, dilation=2, bias=False, padding=2),  # RF = 60
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
        )
        ...
        self.convblock5 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, dilation=2, bias=False, padding=3),  # RF = 60
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
        )
