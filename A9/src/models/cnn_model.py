...
class CNN_Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.convblock1 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, dilation=2, bias=False, padding=1),  # RF = 9
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
        )
        ...
        self.convblock4 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
            nn.Conv2d(32, 64, kernel_size=3, stride=1, dilation=2, bias=False, padding=1),  # RF = 60
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.Dropout(0.1),
        )
